...
int main (int argc, char **argv)
{
	...
	sprintf (out_msg.msg_val, "%s", userCommand);         
        ...
        printf ("%s: Client MsgQ: Message sent successfully\n", userCommand);
	...
	val_server = in_msg.msg_val;
        printf("Client MsgQ: Msg received from the server with val = %s\n", val_server);
